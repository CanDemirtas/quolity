...
object Screenshot {
    ...
    fun openShareScreen(uri: Uri, context: Context) {
        val intent = Intent()
    ...
    private fun saveAndShareImage(bitmap: Bitmap, context: Context, folderName: String) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 29) {
            ...
            if (file.absolutePath != null) {
                ...
                context.contentResolver.insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values)
                openShareScreen(Uri.fromFile(file), context)
            }
        }
    }
